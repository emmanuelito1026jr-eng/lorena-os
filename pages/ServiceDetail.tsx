...
const SERVICES_DATA = {
  buyers: {
    ...
    hero: 'https://placehold.co/1920x800/1A1A1A/C9A84C?text=Happy+Homeowners',
  ...
  sellers: {
    ...
    hero: 'https://placehold.co/1920x800/1A1A1A/C9A84C?text=Sold+Home',
  ...
  investors: {
    ...
    hero: 'https://placehold.co/1920x800/1A1A1A/C9A84C?text=Investment+Properties',
