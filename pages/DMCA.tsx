      ...
      <section className="pt-32 pb-20 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-white border border-gray-200 rounded-lg p-8 md:p-12 space-y-8 text-black/80 leading-relaxed">
            <div>
              <h2 className="text-2xl font-playfair text-gold mb-3">
            ...
            <div>
              <h3 className="text-xl font-playfair text-black mb-2">Filing a DMCA Takedown Notice</h3>
              <p className="mb-3">
            ...
            <div>
              <h3 className="text-xl font-playfair text-black mb-2">Designated Agent</h3>
            ...
            <div>
              <h3 className="text-xl font-playfair text-black mb-2">Counter-Notification</h3>
              <p className="mb-3">
            ...
            <div>
              <h3 className="text-xl font-playfair text-black mb-2">MLS Content</h3>
              <p>
            ...
            <div>
              <h3 className="text-xl font-playfair text-black mb-2">Repeat Infringers</h3>
              <p>
